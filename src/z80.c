...
void Z80_INIT(CPU_Z80* const Z80)
{
    ...
    Z80_SET_PAIR(Z80_A, Z80_F, 0x0000); // AF
    Z80_SET_PAIR(Z80_B, Z80_C, 0x0000); // BC
    Z80_SET_PAIR(Z80_D, Z80_E, 0x0000); // DE
    Z80_SET_PAIR(Z80_H, Z80_L, 0x0000); // HL
    Z80_SET_PAIR(Z80_IXH, Z80_IXL, 0x0000); // IX
    Z80_SET_PAIR(Z80_IYH, Z80_IYL, 0x0000); // IY
