...
Z80_MAKE_OPCODE(ADD)
{
    ...
    Z->FLAGS.FLAG_C = (A + B) > 0xFF;
    Z->FLAGS.FLAG_N = 0;
    Z->FLAGS.FLAG_P = CALC_VFLAG_8(A, B, RESULT);
...
Z80_MAKE_OPCODE(ADC_HL)
{
    ...
    Z80_SET_PAIR(Z80_H, Z80_L, RESULT);
}
...
{
    int INCREMENT = 0;
    U16 HL = Z80_GET_PAIR(Z80_H, Z80_L);
    U16 BC = Z80_GET_PAIR(Z80_B, Z80_C);
    ...
    Z80_SET_PAIR(Z80_B, Z80_C, VALUE);
    Z80_SET_PAIR(Z80_H, Z80_L, VALUE);
}
...
Z80_MAKE_OPCODE(CPI_R)
{
    ...
    if(Z80_GET_PAIR(Z80_B, Z80_C) != 0 && Z->FLAGS.FLAG_Z == 0)
    {
        Z->PC += 2;
        Z->CYCLES += 5;
    }
...
Z80_MAKE_OPCODE(LDI_LDD)
{
    int INCREMENT = 0;
    U16 HL = Z80_GET_PAIR(Z80_H, Z80_L);
    U16 DE = Z80_GET_PAIR(Z80_D, Z80_E);
    U16 BC = Z80_GET_PAIR(Z80_B, Z80_C);
    ...
    Z80_SET_PAIR(Z80_B, Z80_C, VALUE);
    Z80_SET_PAIR(Z80_D, Z80_E, VALUE);
    Z80_SET_PAIR(Z80_H, Z80_L, VALUE);
}
...
Z80_MAKE_OPCODE(LD_B_C)
{
    (void)VALUE;
    Z80_SET_REGISTERS(Z, Z80_B, Z80_GET_REGISTERS(Z, Z80_C));
}
